...
class PdfModel {
  ...
  factory PdfModel.fromJson(Map<String,dynamic> json) => PdfModel(
    chapter2: json['Chapter 2'].toString(),
    chapter5: json['Chapter 5'].toString()
  );
  ...
  bool operator ==(Object other) => identical(this, other)
    || other is PdfModel && chapter2 == other.chapter2 && chapter5 == other.chapter5;
